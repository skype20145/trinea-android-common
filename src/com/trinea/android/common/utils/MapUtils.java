...
public class MapUtils {
     ...
     * </ul>
     */
    public static <K, V> boolean putMapNotEmptyKeyAndValue(Map<K, V> map, K key, V value) {
     ...
     * </pre>
     * 
     * <strong>注意：</strong> 由于对于一般的HashMap，元素的顺序并不是put的顺序，所以使用本函数得到的值并不是第一次put的值，如果想得到第一次put的值，请使用TreeMap<br/>
     * <br/>
     * 
     * @param <V>
     * @param map map
