...
import com.trinea.android.common.utils.ShellUtils.CommandResult;
...
public class PackageUtils {
    ...
    public static int installSilent(Context context, String filePath) {
        ...
        Log.e(TAG, new StringBuilder().append("successMsg:").append(commandResult.successMsg)
                                      .append(", ErrorMsg:").append(commandResult.errorMsg)
                                      .toString());
